    ...
    bool findShortestPaths(int sourceVertex)
    {
        ...
        for (int i = 1; i <= V - 1; i++)
        {
            ...
            for (const Edge &edge : edges)
            {
                ...
                std::cout << "for source " << u << " to destination " << v << " (" << distances[u]
                          << " + " << weight << " < " << distances[v] << ") :";
                    ...
                    distances[u] + weight < distances[v])
                {
                    ...
                    std::cout << " is now " << distances[v] << std::endl;
                }
                else
                {
                    std::cout << " is at infinity" << std::endl;
                }
            }
            std::cout << std::endl;
        }
        ...
        std::cout << "Checking Negative Cycle:" << std::endl;
